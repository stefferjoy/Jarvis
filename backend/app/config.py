...
HOME_BRIDGE_URL = os.getenv("JARVIS_HOME_BRIDGE_URL")
HOME_BRIDGE_TOKEN = os.getenv("JARVIS_HOME_BRIDGE_TOKEN")
HOME_BRIDGE_TIMEOUT_SECONDS = int(os.getenv("JARVIS_HOME_BRIDGE_TIMEOUT_SECONDS", "8"))
